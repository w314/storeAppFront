...
export const PRODUCTS: Product[] = [
  {"id":1,"name":"Foundation","price":9.98,"url":"#","description":"Great book. The foundation for your sci-fi knowledge.","category_id":1},
  {"id":2,"name":"Hitchhiker's Guide to the Galaxy","price":42,"url":"#","description":"Number one book for travellers.","category_id":1},
  {"id":3,"name":"Dishwasher","price":462,"url":"#","description":"For those haters of doing the dishes","category_id":5},
  {"id":4,"name":"Leash","price":12,"url":"#","description":"For those against freedom for dogs.","category_id":6},
  {"id":5,"name":"Hoe","price":92.98,"url":"#","description":"For those yearning for a deep connection to earth.","category_id":4},
